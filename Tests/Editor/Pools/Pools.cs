...
namespace ECS.Tests
{
    public sealed class Pools
    {
        ...
        public void Constructor()
        {
            ...
            var pools10 = new ECS.Pools(null, new OptionsPools(10), OptionsPool.Default, OptionsEntities.Default);
        ...
        public void Add()
        {
            ...
            pools
                .Add<int>()
                .Add<int>(new OptionsPool(10))
                .Add<string>(new OptionsPool(10));
            ...
            pools
                .Add<ATag>()
                .Add<ATag>(new OptionsPool(10))
                .Add<BTag>(new OptionsPool(10));
        ...
        public void Get()
        {
            ...
            pools.Add<int>(new OptionsPool(10));

            Assert.AreEqual(10, pools.GetPool<int>(new OptionsPool(20)).Capacity);
            Assert.AreEqual(10, pools.Get<int>().Capacity);
            Assert.AreEqual(10, pools.Get<string>(new OptionsPool(10)).Capacity);
            Assert.AreEqual(10, pools.GetUnchecked<string>().Capacity);

            pools.Add<ATag>(new OptionsPool(10));

            Assert.AreEqual(10, pools.GetPool<ATag>().Capacity);
            Assert.AreEqual(10, pools.GetTag<ATag>().Capacity);
            Assert.AreEqual(10, pools.GetTag<BTag>(new OptionsPool(10)).Capacity);
